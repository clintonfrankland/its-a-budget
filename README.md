...
Budget Items keeps Budget Name and Category flexible by omitting the Kind and monthly trend columns. Due / Reset and End Date use compact, unpadded month/day dates (for example, `9/4`); edit forms and CSV/Excel exports retain full dates. The All / Scheduled / Allowances filter remains available.
