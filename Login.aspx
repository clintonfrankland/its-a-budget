<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Login.aspx.cs" Inherits="ClintonFrankland.Login" MasterPageFile="~/ClintonFrankland.Master" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="inputPassword" runat="server" TextMode="Password" CssClass="form-control" placeholder="Password" required />
        </div>
